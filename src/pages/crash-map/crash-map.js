...
export default class CrashMap extends React.Component {
                 constructor(props) {
                   ...
                   //初始化state
                   this.state = { Success: null, isLoading: false, Error: null, results: [], placeInfos: [], latitude: 37.78825, longitude: -122.4324, latitudeDelta: 0.0922, longitudeDelta: 0.0421, current_lat: null, current_lng: null };
                 }
                 ...
                 _fetchOpenDataAndUpdate = async () => {
                   try {
                     ...
                     result.map(el => {
                       ...
                       let placeInfo = { XLR: LR.lat, YLR: LR.lng, XUL: UL.lat, YUL: UL.lng, MREASON };
                 ...
                 render() {
                   return <View style={styles.container}>
                       <MapView loadingEnabled style={styles.map} showsUserLocation={true} onRegionChangeComplete={this._onRegionChangeComplete} region={{ latitude: this.state.latitude, longitude: this.state.longitude, latitudeDelta: this.state.latitudeDelta, longitudeDelta: this.state.longitudeDelta }} />
